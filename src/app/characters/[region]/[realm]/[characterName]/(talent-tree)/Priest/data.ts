...
export const data: TalentData = {
  Discipline: {
    name: "Discipline",
    background: "/talents/tree-backgrounds/priest/discipline.jpg",
    icon: "/talents/icons/priest/spell_holy_wordfortitude.jpg",
    talents: {
      "Unbreakable Will": {
        id: 14522,
        name: "Unbreakable Will",
        position: "a2",
        icon: "/talents/icons/priest/spell_magic_magearmor.jpg",
        maxRank: 5,
        reqPoints: 0,
      },
      "Wand Specialization": {
        ...
        position: "a3",
        icon: "/talents/icons/priest/inv_wand_01.jpg",
        maxRank: 5,
        reqPoints: 0,
      },
      "Silent Resolve": {
